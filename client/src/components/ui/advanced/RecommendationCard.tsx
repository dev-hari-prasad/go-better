...
const OPTIONS: Option[] = [
  ...
  },
  {
    ...
    label: "Needs review",
    cta: "Configure",
    ctaStyle: "bg-ink text-[var(--canvas)]",
  },
  {
    key: "none",
    body: (
      ...
      <div className="primitive-card-footer flex items-center justify-between gap-3 border-t border-line bg-inset">
        ...
        <span className="-mr-0.5 flex items-center gap-2">
          <button
            ...
            className={`h-7 cursor-pointer rounded-control px-2.5 text-[12.5px] font-medium shadow-btn
          ...
          <button
            ...
            className={`h-7 cursor-pointer rounded-control px-3 text-[12.5px] font-medium
