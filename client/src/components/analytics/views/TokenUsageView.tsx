...
const mockTimeSeriesData: Record<TimeRange, TokenDataPoint[]> = {
  '24h': [
    { date: '04:00 AM', label: '04:00', promptTokens: 12400, completionTokens: 3200, totalTokens: 15600, cost: 0.051, model: 'Claude 3.5 Sonnet', repo: 'acme-corp/go-better', prNumber: 131, prTitle: 'Fix Redis connection leaks' },
    ...
    { date: '08:00 AM', label: '08:00', promptTokens: 34500, completionTokens: 9800, totalTokens: 44300, cost: 0.145, model: 'Claude 3.5 Sonnet', repo: 'acme-corp/go-better', prNumber: 133, prTitle: 'Prisma query batching' },
    { date: '10:00 AM', label: '10:00', promptTokens: 68200, completionTokens: 18400, totalTokens: 86600, cost: 0.284, model: 'Nemotron 3.5', repo: 'acme-corp/go-better', prNumber: 134, prTitle: 'Add rate limiting middleware' },
    ...
    { date: '02:00 PM', label: '14:00', promptTokens: 125000, completionTokens: 36200, totalTokens: 161200, cost: 0.528, model: 'GPT-4o', repo: 'acme-corp/go-better', prNumber: 136, prTitle: 'Session storage migration' },
    { date: '04:00 PM', label: '16:00', promptTokens: 148500, completionTokens: 42300, totalTokens: 190800, cost: 0.625, model: 'Claude 3.5 Sonnet', repo: 'acme-corp/go-better', prNumber: 137, prTitle: 'Fix race condition in job queue' },
    ...
    { date: '10:00 PM', label: '22:00', promptTokens: 28400, completionTokens: 7600, totalTokens: 36000, cost: 0.118, model: 'Claude 3.5 Sonnet', repo: 'acme-corp/go-better', prNumber: 140, prTitle: 'Zod validation on request payload' },
  ],
  '7d': [
    { date: 'Aug 09', label: 'Aug 09', promptTokens: 245000, completionTokens: 68000, totalTokens: 313000, cost: 1.025, model: 'Claude 3.5 Sonnet', repo: 'acme-corp/go-better', prNumber: 135, prTitle: 'Batch ingestion pipeline' },
    ...
    { date: 'Aug 11', label: 'Aug 11', promptTokens: 420000, completionTokens: 118000, totalTokens: 538000, cost: 1.762, model: 'Claude 3.5 Sonnet', repo: 'acme-corp/go-better', prNumber: 137, prTitle: 'Distributed tracing middleware' },
    ...
    { date: 'Aug 13', label: 'Aug 13', promptTokens: 680000, completionTokens: 192000, totalTokens: 872000, cost: 2.855, model: 'Claude 3.5 Sonnet', repo: 'acme-corp/go-better', prNumber: 139, prTitle: 'Refactor Auth middleware' },
    ...
    { date: 'Aug 15', label: 'Aug 15', promptTokens: 380000, completionTokens: 104000, totalTokens: 484000, cost: 1.585, model: 'Gemini 1.5 Pro', repo: 'acme-corp/go-better', prNumber: 141, prTitle: 'Prisma connection pooling' },
  ],
  '30d': [
    { date: 'Jul 16-22', label: 'W29', promptTokens: 1450000, completionTokens: 410000, totalTokens: 1860000, cost: 6.09, model: 'Claude 3.5 Sonnet', repo: 'acme-corp/go-better', prNumber: 120, prTitle: 'Initial OpenAPI generator' },
    ...
    { date: 'Jul 30-Aug 05', label: 'W31', promptTokens: 2640000, completionTokens: 740000, totalTokens: 3380000, cost: 11.07, model: 'Claude 3.5 Sonnet', repo: 'acme-corp/go-better', prNumber: 130, prTitle: 'Vector embeddings worker' },
    ...
    { date: 'Aug 13-15', label: 'W33', promptTokens: 1570000, completionTokens: 438000, totalTokens: 2008000, cost: 6.58, model: 'Claude 3.5 Sonnet', repo: 'acme-corp/go-better', prNumber: 142, prTitle: 'Auth token validation updates' },
  ],
  '90d': [
    { date: 'Jun 2026', label: 'Jun', promptTokens: 5800000, completionTokens: 1620000, totalTokens: 7420000, cost: 24.30, model: 'Claude 3.5 Sonnet', repo: 'acme-corp/go-better', prNumber: 110, prTitle: 'Core framework bootstrap' },
    ...
    { date: 'Aug 2026', label: 'Aug', promptTokens: 9310000, completionTokens: 2630000, totalTokens: 11940000, cost: 39.10, model: 'Claude 3.5 Sonnet', repo: 'acme-corp/go-better', prNumber: 142, prTitle: 'AI Review automated workflow' },
  ],
  'all': [
    { date: 'Q1 2026', label: 'Q1', promptTokens: 12500000, completionTokens: 3500000, totalTokens: 16000000, cost: 52.40, model: 'GPT-4o', repo: 'acme-corp/go-better', prNumber: 90, prTitle: 'Architecture v1' },
